...
public class ActivityElegirPersonaje extends AppCompatActivity {

    private ImageButton imgbtn_per1, imgbtn_per2, imgbtn_per3, imgbtn_per4, imgbtn_per5, imgbtn_per6;
    ...
    private String nameSP = "datosEP"; //nombre del SharedPreferences
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbtn_per1 = findViewById(R.id.imgbtn_per1);
        ...
        imgbtn_per2 = findViewById(R.id.imgbtn_per2);
        imgbtn_per2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity_ppl(R.drawable.pj_blanco);
            }
        });

        imgbtn_per3 = findViewById(R.id.imgbtn_per3);
        imgbtn_per3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity_ppl(R.drawable.pj_celeste);
            }
        });

        imgbtn_per4 = findViewById(R.id.imgbtn_per4);
        imgbtn_per4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity_ppl(R.drawable.pj_mora);
            }
        });

        imgbtn_per5 = findViewById(R.id.imgbtn_per5);
        imgbtn_per5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity_ppl(R.drawable.pj_prado);
            }
        });

        imgbtn_per6 = findViewById(R.id.imgbtn_per6);
        imgbtn_per6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity_ppl(R.drawable.pj_rubio);
            }
        });
    ...
    public void marcarBotones(String nameSP, SharedPreferences sp) {
